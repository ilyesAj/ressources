...
public interface ResourcesInterface {
	 ...
	 */
	public void createPerson(String personId, String firstName, String lastName, String email, Status status) throws InvalidInputException;
	 ...
	 * @throws InvalidInputException
	 */
	public void createRoom(String roomId, String roomName, Integer capacity, String buildingName) throws InvalidInputException;
	 ...
	 * @throws InvalidInputException
	 */
	public void createTimeSlot(String timeSlotId, LocalDate day, LocalTime start, LocalTime end) throws InvalidInputException;
	...
	/**
	 * Créer plusieurs réservations pour une personne, une salle et une liste de créneaux donnés
	 * @param person
	 * @param room
	 * @param timeSlots
	 * @throws InvalidInputException
	 ...
	 * @throws InvalidInputException
	 */
	public void editReservation(Reservation reservation, TimeSlot timeSlot) throws NullElementException, InvalidInputException;
